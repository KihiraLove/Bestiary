...
public class BeastEntry {
	...
	public BeastEntry(String name, ImageEntry image, String altIdentifier, boolean members, boolean isNew, LocalDate dateAdded, int combat, int health, int attack, int defence, int magic, int range) {
		this.name = name;
		this.image = image;
